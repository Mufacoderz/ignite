...
export default function Register() {
  ...
  return (
    <div style={{
      ...
      background: 'linear-gradient(135deg, #fff 0%, #FFF3EE 50%, #FFEAEA 100%)', padding: 20
    }}>
      <div style={{ width: '100%', maxWidth: 440 }}>
        <div style={{ textAlign: 'center', marginBottom: 36 }}>
          <div style={{ width: 64, height: 64, borderRadius: 18, background: 'linear-gradient(135deg, #D92B2B, #FF6B35)', display: 'inline-flex', alignItems: 'center', justifyContent: 'center', fontSize: 32, marginBottom: 16, boxShadow: '0 8px 24px rgba(217,43,43,0.3)' }}>🔥</div>
          ...
          <p style={{ color: '#9E9087', fontSize: 14 }}>Mulai perjalanan fitness kamu</p>
        </div>
        <div className="card" style={{ padding: 32 }}>
          <h2 style={{ fontSize: 24, marginBottom: 24, color: '#2D2825' }}>Buat Akun</h2>
          ...
          <form onSubmit={handleSubmit} style={{ display: 'flex', flexDirection: 'column', gap: 16 }}>
            ...
            <div className="form-group">
              ...
              <input className="input" type="password" placeholder="Min. 6 karakter" value={form.password}
          ...
          <p style={{ textAlign: 'center', marginTop: 20, fontSize: 14, color: '#9E9087' }}>
            Sudah punya akun? <Link to="/login" style={{ color: '#D92B2B', fontWeight: 600 }}>Login</Link>
          </p>
        </div>
      </div>
    </div>
